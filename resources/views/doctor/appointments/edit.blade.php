        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('doctor.appointments.update', $appointment) }}" id="doctor-appointment-edit-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="appointment_time" class="block mt-1 w-full" type="time" name="appointment_time" :value="old('appointment_time', $appointment->appointment_time)" required />
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <x-text-input id="reason" class="block mt-1 w-full" type="text" name="reason" :value="old('reason', $appointment->reason)" required />
                                ...
                                <div>
                                    ...
                                    <textarea id="notes" name="notes" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('notes', $appointment->notes) }}</textarea>
                        ...
                        <div class="mt-8 p-6 bg-blue-50 rounded-lg border border-blue-200">
                            ...
                            <x-appointment-availability
                                ...
                                :selected-date="old('appointment_date', $appointment->appointment_date->format('Y-m-d'))"
                            />
                        </div>

                        <div class="flex items-center justify-end mt-8 space-x-4">
                            <a href="{{ route('doctor.appointments.show', $appointment) }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition-colors duration-200">
                                Cancel
                            </a>
                            <button type="submit" class="px-6 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
