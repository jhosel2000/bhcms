            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-semibold">Health Announcements</h3>
                        <a href="{{ route('midwife.announcements.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Create Announcement
                        </a>
                    </div>
                                ...
                                <div class="border p-4 rounded shadow-sm {{ $announcement->priority == 'high' ? 'border-red-300 bg-red-50' : ($announcement->priority == 'medium' ? 'border-yellow-300 bg-yellow-50' : 'border-gray-300') }}">
                                    ...
                                    <div class="flex justify-between items-center text-sm text-gray-500">
                                        ...
                                        <div class="flex space-x-2">
                                            <a href="{{ route('midwife.announcements.show', $announcement) }}" class="text-blue-600 hover:text-blue-800">View</a>
                                            <a href="{{ route('midwife.announcements.edit', $announcement) }}" class="text-green-600 hover:text-green-800">Edit</a>
                                            <form method="POST" action="{{ route('midwife.announcements.destroy', $announcement) }}" class="inline">
                                                @csrf
                                                @method('DELETE')
