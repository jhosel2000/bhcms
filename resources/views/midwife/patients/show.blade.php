    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900">
                ...
                <p><strong>Age:</strong> {{ $patient->date_of_birth ? $patient->date_of_birth->age : 'N/A' }}</p>
                ...
                <div class="mt-6 space-x-2">
                    <a href="{{ route('midwife.patients.edit', $patient->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white px-4 py-2 rounded">Edit Patient</a>
                    <a href="{{ route('midwife.patients.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white px-4 py-2 rounded">Back to Patients</a>
                </div>
            </div>
        </div>
    </div>
