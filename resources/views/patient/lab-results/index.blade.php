                ...
                <div class="p-6">
                    ...
                    <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 rounded">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-blue-700">You can view your lab results, but cannot modify them. Contact your healthcare provider for questions.</p>
                            </div>
                        </div>
                    </div>

                    <h3 class="text-lg font-semibold mb-4 flex items-center">
                        <i class="fas fa-flask mr-2 text-green-600"></i> My Lab Results
                    </h3>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">{{ $labResult->test_name }}</div>
                                            <div class="text-sm text-gray-500">{{ $labResult->category }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">{{ $labResult->result_value }} {{ $labResult->unit }}</div>
                                            <div class="text-sm text-gray-500">{{ $labResult->reference_range }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('patient.lab-results.show', $labResult) }}" class="text-blue-600 hover:text-blue-900">View</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <h3 class="text-lg font-medium text-gray-900 mb-2">No Lab Results</h3>
                            <p class="text-gray-500">Your lab results will appear here once performed by your healthcare provider.</p>
                        </div>
                    @endif
                </div>
            </div>
